...
create table "REGISTERED_PERSONS" ("ID" BIGSERIAL PRIMARY KEY,"REGISTRATION_ID" BIGINT NOT NULL,"FIRST_NAME" VARCHAR(254) NOT NULL,"LAST_NAME" VARCHAR(254) NOT NULL,"EMAIL" VARCHAR(254) NOT NULL,"DATE_OF_BIRTH" VARCHAR(254) NOT NULL,"CLUB_NUMBER" VARCHAR(254) NOT NULL,"NATIONALITY" VARCHAR(254) NOT NULL,"SELECTED_DINING" INTEGER NOT NULL,"CONTACT_PERSON" INTEGER NOT NULL);
