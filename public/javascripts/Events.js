                ...
                React.createElement(RB.Modal, {onRequestHide: this.dismiss, onHide: this.dismiss, show: this.props.show, bsStyle: "primary", dialogClassName: "modal-large"}, 
                    React.createElement(Form, {onSubmit: this.submitForm, model: this.props.event}, 
                        ...
                        React.createElement(RB.Modal.Body, null, 
                            ...
                            React.createElement(DateField, {type: "text", name: "registrationEndDate", label: "Registration ends:", id: "endField", 
                              errorMessage: "End date is mandatory", required: "true", labelClassName: "col-sm-3 control-label", wrapperClassName: "col-xs-6"}), 
                            React.createElement(Input, {type: "checkbox", label: "Is dining optional:", name: "diningOptional", 
