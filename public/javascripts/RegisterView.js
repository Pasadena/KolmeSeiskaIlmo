                ...
                return (
                    React.createElement(FormFragment, {key: order, ref: order}, 
                        React.createElement(Panel, {header: headerName, bsStyle: "info"}, 
                            ...
                            React.createElement(Input, {type: "text", placeholder: "pp.kk.vvvv", label: "Syntymäaika (pp.kk.vvvv):*", id: "dobField", name: "dateOfBirth", labelClassName: "col-sm-2 control-label", wrapperClassName: "col-xs-4", required: "true"}), 
